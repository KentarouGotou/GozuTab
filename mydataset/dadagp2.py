...
def guitarpro2tokens(song, output_file, artist, verbose=False):
...
def tokens2guitarpro(all_tokens, verbose=False):
    ...
    verbose and print("=======\nFirst measure")
    for i in all_measures[0]:
        print(i, all_measures[0][i])
    
    with open("output/test.json", "w") as f:
        json.dump(all_measures, f, indent=4)
...
def dadagp_encode(input_file, output_file, artist_token):
    ...
    tokens = guitarpro2tokens(song, output_file, artist_token, verbose=True)
